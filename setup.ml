...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2cd08a422abed4cd9de4be9f4818455c) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          synopsis = "Entropy provider for MirageOS on Solo5";
          description =
            Some [OASISText.Para "Entropy provider for MirageOS on Solo5."];
          categories = [];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources = ["entropy_cpu_solo5_stubs.c"];
                      bs_data_files = [];
                      bs_ccopt =
                        [
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "g\012\249._\249O\028B, \212\229\213\240\227";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
